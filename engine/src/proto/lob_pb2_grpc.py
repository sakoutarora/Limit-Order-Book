...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLob = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetOder = channel.unary_unary(
                '/orders.OrderService/GetOder',
                request_serializer=src_dot_proto_dot_lob__pb2.CancelOrderRequest.SerializeToString,
                response_deserializer=src_dot_proto_dot_lob__pb2.Order.FromString,
                _registered_method=True)
...
class OrderServiceServicer(object):
    ...
    def GetOder(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOder': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOder,
                    request_deserializer=src_dot_proto_dot_lob__pb2.CancelOrderRequest.FromString,
                    response_serializer=src_dot_proto_dot_lob__pb2.Order.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def GetOder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/orders.OrderService/GetOder',
            src_dot_proto_dot_lob__pb2.CancelOrderRequest.SerializeToString,
            src_dot_proto_dot_lob__pb2.Order.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
