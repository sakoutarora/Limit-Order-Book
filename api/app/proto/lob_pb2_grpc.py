...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetOder = channel.unary_unary(
                ...
                request_serializer=app_dot_proto_dot_lob__pb2.CancelOrderRequest.SerializeToString,
                response_deserializer=app_dot_proto_dot_lob__pb2.Order.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOder': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOder,
                    request_deserializer=app_dot_proto_dot_lob__pb2.CancelOrderRequest.FromString,
                    response_serializer=app_dot_proto_dot_lob__pb2.Order.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def GetOder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/orders.OrderService/GetOder',
            app_dot_proto_dot_lob__pb2.CancelOrderRequest.SerializeToString,
            app_dot_proto_dot_lob__pb2.Order.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
